...
export default function AdminPage() {
  ...
  const resetForm = () => {
    setFormData({
      ...
      eventPrice: '', eventOriginalPrice: '', eventCapacity: '100', eventXp: '200', eventImage: ''
    });
    setEditingItem(null);
  };
  ...
  const openEditModal = (item: Hotel | Quest | Event, type: 'hotel' | 'quest' | 'event') => {
    ...
    if (type === 'hotel') {
      ...
      setFormData(prev => ({
        ...
        eventCapacity: e.capacity.toString(), eventXp: e.xpReward.toString(), eventImage: e.image || ''
      }));
    }
    setShowModal(true);
  };
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="number" value={formData.originalPrice} onChange={(e) => setFormData({...formData, originalPrice: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">Discounted Price ($)</label>
                      <input type="number" value={formData.discountedPrice} onChange={(e) => setFormData({...formData, discountedPrice: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">XP Reward</label>
                      <input type="number" value={formData.xpReward} onChange={(e) => setFormData({...formData, xpReward: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                    <div>
              ...
              {modalType === 'quest' && (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">XP Reward</label>
                      <input type="number" value={formData.questXp} onChange={(e) => setFormData({...formData, questXp: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm text-nomad-gray mb-1 flex items-center gap-2">
                      <ExternalLink className="w-4 h-4" /> Quest Link (Optional)
                    </label>
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="number" value={formData.eventPrice} onChange={(e) => setFormData({...formData, eventPrice: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">Original Price ($)</label>
                      <input type="number" value={formData.eventOriginalPrice} onChange={(e) => setFormData({...formData, eventOriginalPrice: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">Capacity</label>
                      <input type="number" value={formData.eventCapacity} onChange={(e) => setFormData({...formData, eventCapacity: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                    <div>
                      <label className="block text-sm text-nomad-gray mb-1">XP Reward</label>
                      <input type="number" value={formData.eventXp} onChange={(e) => setFormData({...formData, eventXp: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" required />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm text-nomad-gray mb-1">Image URL</label>
                    <input type="url" value={formData.eventImage} onChange={(e) => setFormData({...formData, eventImage: e.target.value})} className="w-full px-3 py-2 bg-nomad-dark border border-nomad-border rounded-lg text-white focus:border-crypto-green" placeholder="https://example.com/event.jpg" />
                  </div>
                </>
              )}
